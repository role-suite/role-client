...
class CollectionRunResultCard extends StatelessWidget {
  const CollectionRunResultCard({super.key, required this.result, required this.isActive});
        ...
        children: [
          ...
          if (result.errorMessage != null && result.errorMessage!.isNotEmpty)
            Padding(
              ...
              child: Text(result.errorMessage!, style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.error)),
            ),
        ],
      ),
    );
