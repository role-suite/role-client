...
class AppTypography {
  ...
  TextStyle get title =>
      TextStyle(fontFamily: sansFamily, fontSize: 14, fontWeight: FontWeight.w600, color: colors.textPrimary, height: 1.3);
  TextStyle get body =>
      TextStyle(fontFamily: sansFamily, fontSize: 13, fontWeight: FontWeight.w400, color: colors.textPrimary, height: 1.4);
  TextStyle get bodyStrong =>
      TextStyle(fontFamily: sansFamily, fontSize: 13, fontWeight: FontWeight.w600, color: colors.textPrimary, height: 1.4);
  TextStyle get label =>
      TextStyle(fontFamily: sansFamily, fontSize: 12, fontWeight: FontWeight.w500, color: colors.textSecondary, height: 1.3);
  TextStyle get caption =>
      TextStyle(fontFamily: sansFamily, fontSize: 11, fontWeight: FontWeight.w400, color: colors.textMuted, height: 1.3);
