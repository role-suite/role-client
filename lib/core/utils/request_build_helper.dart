...
class RequestBuildHelper {
  ...
  static ({Map<String, String> headers, dynamic body}) buildForSend(ApiRequestModel request, String Function(String) resolve, {String? rawBody}) {
    final headers = <String, String>{for (final e in request.headers.entries) e.key: resolve(e.value)};
  ...
  static void _applyAuth(Map<String, String> headers, AuthType authType, Map<String, String> authConfig, String Function(String) resolve) {
    switch (authType) {
      case AuthType.none:
        break;
  ...
  static dynamic _buildBody(ApiRequestModel request, String Function(String) resolve, String? rawBody) {
      ...
      case BodyType.formData:
        {
          ...
          final formDataFields = <String, String>{};
          for (final e in fields.entries) {
            if (e.key.trim().isEmpty) continue;
            formDataFields[e.key] = resolve(e.value);
          }
          return RoleSdkFormData(fields: formDataFields);
        }
