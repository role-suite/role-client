...
class DataSourceConfig {
  const DataSourceConfig({required this.baseUrl, this.apiKey, this.apiStyle = ApiStyle.rest});
  ...
  DataSourceConfig copyWith({String? baseUrl, String? apiKey, ApiStyle? apiStyle}) {
    return DataSourceConfig(baseUrl: baseUrl ?? this.baseUrl, apiKey: apiKey ?? this.apiKey, apiStyle: apiStyle ?? this.apiStyle);
  }
